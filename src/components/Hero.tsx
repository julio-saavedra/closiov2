...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="min-h-screen w-full text-white flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-16 sm:pb-20 relative overflow-hidden">
